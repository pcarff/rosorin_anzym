...
class JointPositionController():
    def __init__(self, joint_config, joint_name):
        ...
        self.RADIANS_PER_ENCODER_TICK = 240 / 360 * (math.pi * 2) / 1000  # Pulse width ---> Radians (脉宽--->弧度)
        self.ENCODER_TICKS_PER_RADIAN = 1 / self.RADIANS_PER_ENCODER_TICK # Radians ---> Pulse width (弧度-->脉宽)
    ...
    def pos_rad_to_pulse(self, pos_rad):  #Radians ---> Pulse width (弧度--->脉宽)
    ...
    def pos_pulse_to_rad(self, pos_pulse):  #Pulse width ---> Radians (脉宽--->弧度)
