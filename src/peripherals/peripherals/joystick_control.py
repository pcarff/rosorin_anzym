...
class JoystickController(Node):
    def __init__(self, name):
        ...
        self.machine = os.environ.get('MACHINE_TYPE', 'Ackermann')
        self.get_logger().info(f'Joystick Controller initialized for machine: {self.machine}')
    ...
    def axes_callback(self, axes):
        ...
        if 'Mecanum' in self.machine or 'Differential' in self.machine:
            ...
            twist.linear.x = val_map(axes['ly'], -1, 1, -self.max_linear, self.max_linear)
            steering_angle = val_map(axes['rx'], -1, 1, -math.radians(34), math.radians(34))
