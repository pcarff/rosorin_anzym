...
def generate_launch_description():
    return LaunchDescription([
        Node(
            ...
            remappings=[
                ("/aurora/depth/image_raw", "/depth_cam/depth0/image_raw"),
                ("/aurora/ir/camera_info", "/depth_cam/depth0/camera_info"),
                ("/aurora/ir/image_raw", "/depth_cam/ir0/image_raw"),
                ("/aurora/points2", "/depth_cam/depth0/points"),
                ("/aurora/rgb/camera_info", "/depth_cam/rgb0/camera_info"),
                ("/aurora/rgb/image_raw", "/depth_cam/rgb0/image_raw"),
            ],
            arguments=None,
            output="screen",
        ),
        ...
        Node(
            ...
            arguments = ['0', '0', '0', '-1.57', '0', '-1.57', 'camera_link0', 'depth_camera_link']
        ),
        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            name='camera_to_rgb_tf',
            arguments = ['0', '0', '0', '0', '0', '0', 'camera_link0', 'rgb_camera_link']
        ),
        Node(
            ...
            remappings=[
                ('in', '/depth_cam/rgb0/image_raw'),
                ('out/compressed', '/depth_cam/rgb0/image_raw/compressed')
            ]
        ),
        Node(
            package='image_transport',
            ...
            remappings=[
                ('in', '/depth_cam/depth0/image_raw'),
                ('out/compressedDepth', '/depth_cam/depth0/image_raw/compressedDepth')
            ]
        ),
